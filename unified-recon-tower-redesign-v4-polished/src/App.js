...
function App() {
  ...
  useEffect(() => {
    const targets = document.querySelectorAll(
      '.answer-panel, .loading-card, .generic-response, .glass-card, .kpi-card, .landing-card, .lane-row, .attention-item, .timeline-item, .file-card, .driver-card, .anomaly-card, .action-item, .incident-item, .cost-recon-item, .cost-anomaly-item, .recon-cost-row, .cost-node, .generic-chart-row, .daily-chart-mini, .daily-mini-row'
    );
